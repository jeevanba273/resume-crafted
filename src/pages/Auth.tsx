...
const Auth = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center py-12">
        <div className="w-full max-w-md px-8 py-10 rounded-lg shadow-md bg-slate-900">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold">
              {isLogin ? "Login to InstaResume Pro" : "Create an Account"}
            </h1>
            <p className="text-sm text-muted-foreground mt-2">
              {isLogin ? "Enter your credentials to access your account" : "Sign up to optimize your resume for ATS systems"}
            </p>
          </div>
