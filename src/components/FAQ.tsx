...
const FAQ = () => {
  const faqs = [{
    ...
    answer: "ATS (Applicant Tracking System) is software used by 98% of Fortune 500 companies and a majority of Indian recruiters to filter resumes before a human sees them. If your resume isn't optimized for ATS, it may be automatically rejected even if you're qualified for the role."
  }, {
    question: "How does Resume Crafted optimize my resume for ATS?",
    answer: "Resume Crafted analyzes your resume against the job description, identifies missing keywords, and restructures your content to be ATS-friendly. We ensure proper formatting, appropriate keyword density, and clear section headers that ATS systems can easily parse."
  }, {
    question: "What file formats does Resume Crafted support?",
    answer: "You can upload your existing resume in DOCX or PDF format. Our system will extract the content and use it to create an optimized version. You can also start from scratch using our templates."
  }, {
  ...
  return <section className="py-20 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 max-w-4xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-bold mb-4 animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
            Frequently Asked <span className="text-primary">Questions</span>
          </h2>
          <p className="text-lg text-muted-foreground animate-fade-in" style={{
          animationDelay: '0.3s'
        }}>
        ...
        <Accordion type="single" collapsible className="w-full">
          {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="animate-fade-in border-b dark:border-gray-800 group" style={{
